...
def main(ps):
    parser =ps
    png_path = parser.png_path
    output_folder = parser.output_folder
    model_json_file = parser.model_json_file
    model_weights_file = parser.model_weights_file
    style = parser.style
    print_generated_output = parser.print_generated_output
    print_bleu_score = parser.print_bleu_score
    original_gui_filepath = parser.original_gui_filepath
